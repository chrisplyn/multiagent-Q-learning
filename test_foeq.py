...
player_a = foeQplayer(numStates=len(total_states),numActionsA=5,numActionsB=5,\
                   decay=0.9999954, expl=1, gamma=0.9,x=2, y=0, has_ball=False, p_id='A')
player_b = foeQplayer(numStates=len(total_states),numActionsA=5,numActionsB=5,\
                   decay=0.9999954, expl=1, gamma=0.9,x=1, y=0, has_ball=True, p_id='B')
...
sol_A = np.array(player_a.updateV(state_s))
sol_B = np.array(player_b.updateV(state_s))
